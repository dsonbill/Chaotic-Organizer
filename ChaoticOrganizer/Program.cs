...
namespace ChaoticOrganizer
{
    class Programz
    {
        ...
        public static float RandomFunction(double randomness)
        {
        ...
        static void Main(string[] args)
        {
            for (int i = 0; i < int.MaxValue; i++)
            {
                ...
                //Memory System
                string theory = output.Replace((char)66, " ".ToCharArray()[0]).Replace((char)65, " ".ToCharArray()[0]);
        ...
        static string ReplacementSystem(string input, char replacement, int start, int end)
        {
            string output = input;
        ...
        static float ScaleBetweenNumber(float measurement, float measMin, float measMax, float scaleMin, float scaleMax)
        {
